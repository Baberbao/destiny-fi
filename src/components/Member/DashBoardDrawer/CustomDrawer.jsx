...
const educationData = [{ title: "LIVE LESSONS", link: "/member/live-lessons" }];

const toolsData = [
  { title: "DEFI FIRE FX", link: "/member/product/defifire-fx" },
];

const tokenData = [
  { title: "INFORMATION", link: "/member/token/information" },
  { title: "TRANSACTIONS", link: "/member/token/transactions" },
  { title: "REWARD STATISTICS", link: "/member/token/reward-statistics" },
];

const communityData = [{ title: "ROADMAP", link: "/member/roadmap" }];
      ...
      <List>
          ...
          >
            ...
            >
              <Stack alignItems="center" justifyContent={"center"}>
                {educationData.map(({ title, link }, index) => (
                  <HashLink
        ...
        >
          ...
          >
            ...
            >
              <Stack alignItems="center" justifyContent={"center"}>
                {toolsData.map(({ title, link }, index) => (
                  <HashLink
                    onClick={toggleDrawer(anchor, false)}
                    onKeyDown={toggleDrawer(anchor, false)}
                    key={index}
        ...
        >
          ...
          >
            ...
            >
              <Stack alignItems="center" justifyContent={"center"}>
                {tokenData.map(({ title, link }, index) => (
                  <HashLink
                    onClick={toggleDrawer(anchor, false)}
                    onKeyDown={toggleDrawer(anchor, false)}
                    key={index}
        ...
        >
          ...
          >
            <AccordionSummary
              aria-controls={`panel${4}bh-content`}
              id={`panel${4}bh-header`}
              className="borderRad"
              expandIcon={
                <ArrowDropDownIcon sx={{ color: "white", fontSize: "20px" }} />
              }
            ...
            >
              <Stack alignItems="center" justifyContent={"center"}>
                {communityData.map(({ title, link }, index) => (
                  <HashLink
                    onClick={toggleDrawer(anchor, false)}
                    onKeyDown={toggleDrawer(anchor, false)}
                    key={index}
        ...
        >
          ...
          >
            <AccordionSummary
              aria-controls={`panel${5}bh-content`}
              id={`panel${5}bh-header`}
              className="borderRad"
              expandIcon={
                <ArrowDropDownIcon sx={{ color: "white", fontSize: "20px" }} />
              }
