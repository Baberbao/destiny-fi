          ...
          {matches1 ? (
            ...
            >
              <Box px="5px">
                <div class="dropdown1">
                  <button class="dropbtn1">
                    EDUCATION <KeyboardArrowDownIcon sx={{ pt: "13px" }} />{" "}
                  </button>
              ...
              <Box px="5px">
                <div class="dropdown1">
                  <button class="dropbtn1">
                    TOOLS <KeyboardArrowDownIcon sx={{ pt: "13px" }} />{" "}
                  </button>
                  <div class="dropdown-content1">
                    <HashLink
              ...
              <Box px="5px">
                <div class="dropdown1">
                  <button class="dropbtn1">
                    TOKEN <KeyboardArrowDownIcon sx={{ pt: "13px" }} />{" "}
                  </button>
                  <div class="dropdown-content1">
                    <HashLink
                      to={"/member/token/information"}
                      style={{
                        textDecoration: "none",
                        display: "flex",
                        alignItems: "center",
                    ...
                    <HashLink
                      to={"/member/token/reward-statistics"}
                      style={{
                        textDecoration: "none",
                        display: "flex",
                        alignItems: "center",
              ...
              <Box px="5px">
                <div class="dropdown1">
                  <button class="dropbtn1">
                    COMMUNITY <KeyboardArrowDownIcon sx={{ pt: "13px" }} />{" "}
                  </button>
                  <div class="dropdown-content1">
                    <HashLink
                      to={"/member/roadmap"}
              ...
              <Box pt="6px" px="10px">
                <div class="dropdown1">
                  ...
                  >
                    ...
                    />
                    <span style={{ margin: "0px  5px" }}>Account #1</span>
                    <KeyboardArrowDownIcon sx={{ pt: "0px", ml: "10px" }} />
                  </button>
                  <div class="dropdown-content1">
                    <HashLink
                  ...
                  <Slider
                    ...
                    sx={{
                      ...
                      "& .MuiSlider-track": {
                        ...
                        backgroundColor: "transparent",
                        backgroundImage:
                          "linear-gradient(90deg,#e09504,#e7ca05)",
                      },
                      "& .MuiSlider-thumb": {
                        width: "8px",
                        height: "8px",
